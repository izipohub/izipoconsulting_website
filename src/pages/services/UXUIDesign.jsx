// pages/services/UXUIDesign.jsx
import { motion } from 'framer-motion';
import { Link } from 'react-router-dom';
import { 
  ArrowRight, Zap, Shield, Rocket, Users, Clock,
  Star, TrendingUp, Heart, Palette, 
  Layout, Code, Server, Globe, PenTool,
  BarChart, CheckCircle, Award, Target, Briefcase, 
  Eye, Layers, Smartphone, Monitor, Tablet,
  Sparkles, Lightbulb
} from 'lucide-react';
import { CTA } from '../../components';
import UXHero from '../../assets/serviceshero/uxuihero.jpg';
...
const UXUIDesign = () => {
  ...
  const benefits = [
    { icon: Users, title: "User-Centered Design", description: "Designs based on real user research and testing" },
    { icon: TrendingUp, title: "Higher Conversion", description: "Optimized interfaces that drive user action" },
    { icon: Heart, title: "Increased Engagement", description: "Interfaces users love to interact with" },
    { icon: Eye, title: "Visual Appeal", description: "Beautiful, modern designs that stand out" },
    { icon: Zap, title: "Faster Development", description: "Clear design systems speed up development" },
    { icon: Shield, title: "Accessibility First", description: "Designs that work for everyone" }
  ];

  const process = [
    { step: "01", title: "Research & Discovery", description: "User interviews, competitor analysis, and requirement gathering" },
    { step: "02", title: "User Personas", description: "Creating detailed user profiles and journey maps" },
    { step: "03", title: "Information Architecture", description: "Structuring content and navigation" },
    { step: "04", title: "Wireframing", description: "Low-fidelity layouts and user flows" },
    { step: "05", title: "Visual Design", description: "High-fidelity UI with brand elements" },
    { step: "06", title: "Prototyping & Testing", description: "Interactive prototypes and user testing" }
  ];
  ...
  const features = [
    ...
    {
      title: "Wireframing",
      description: "Low and high-fidelity wireframes for layout planning",
      icon: Layout
    },
    {
      title: "Visual Design",
      description: "Stunning interfaces with modern design trends",
      icon: Palette
    },
    {
      title: "Prototyping",
    ...
    },
    {
      ...
      description: "Consistent, scalable design components and guidelines",
      icon: Layers
    },
    {
  ...
  const projects = [
    {
      ...
      description: "Complete UX overhaul for major online retailer",
            ...
            <div className="max-w-4xl">
              ...
              >
                ...
                >
                  ...
                  <span className="text-cyan-300 text-sm font-medium">UX/UI Design</span>
                </motion.div>
                ...
                >
                  <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-8 backdrop-blur-sm bg-black/20 p-6 rounded-2xl border border-white/10 inline-block">
                    We create beautiful, intuitive interfaces that users love. Through research, 
                    testing, and iterative design, we craft experiences that drive engagement and conversion.
                  </p>
                </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">What We Design</h2>
              <div className="w-20 h-1 bg-gradient-to-r from-cyan-500 to-blue-500 mx-auto rounded-full" />
              <p className="text-gray-400 mt-6 max-w-2xl mx-auto">
                Comprehensive design solutions for every digital product
              </p>
            </div>
          ...
          >
            <div className="text-center mb-12">
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-cyan-500 to-blue-500 mx-auto rounded-full" />
              <p className="text-gray-400 mt-6 max-w-2xl mx-auto">
                What makes our design services stand out
              </p>
            </div>
          ...
          >
            <div className="bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10 rounded-3xl p-12 border border-white/10">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                Let's discuss your design needs and create interfaces your users will love
              </p>
              <Link
                to="/contact"
